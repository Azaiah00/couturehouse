  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-content section-pad">
        ...
        <section><h2>Analytics and storage</h2><p>If measurement is enabled, we may use Google Analytics to understand visits and interactions so we can improve the site. The site may also store a small preference in your browser to remember whether you turned the optional soundtrack on. You can clear cookies and browser storage through your browser settings.</p></section>
