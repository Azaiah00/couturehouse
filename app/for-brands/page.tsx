...
export default function ForBrandsPage() {
  ...
  const pricingTiers = [
    ...
    },
    {
      ...
      examplePrice: "$12,000",
      exampleCount: "Full annual scale",
  ...
  return (
    <div className="pt-20 sm:pt-24 pb-16 sm:pb-24">
      ...
      <section id="pricing" className="container mx-auto px-4 sm:px-6 mb-12 sm:mb-16 md:mb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <div className="bg-white rounded-xl p-6 border border-rose-gold/20 text-center hover:shadow-lg transition-shadow">
                <div className="w-16 h-16 mx-auto mb-4 bg-rose-gold/10 rounded-full flex items-center justify-center">
                  <CheckCircle2 className="w-8 h-8 text-rose-gold" />
                </div>
              ...
              <div className="bg-white rounded-xl p-6 border border-rose-gold/20 text-center hover:shadow-lg transition-shadow">
                <div className="w-16 h-16 mx-auto mb-4 bg-rose-gold/10 rounded-full flex items-center justify-center">
                  <Zap className="w-8 h-8 text-rose-gold" />
                </div>
        ...
        <SectionReveal distance={30} delay={0.2}>
              ...
              <div className="bg-white rounded-xl p-6 border border-neutral-200">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between items-center pb-3 border-b border-neutral-100">
                    ...
                    <span className="font-bold text-charcoal">$1,500</span>
                  </div>
                  <div className="flex justify-between items-center pb-3 border-b border-neutral-100">
                    <span className="text-neutral-600">Monthly Growth</span>
                    <span className="font-bold text-charcoal">$3,500</span>
                  </div>
                  <div className="flex justify-between items-center pb-3 border-b border-rose-gold/30">
                    ...
                    <span className="font-bold text-rose-gold">Custom</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-neutral-600">Annual Scale</span>
                    <span className="font-bold text-rose-gold">$12,000</span>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto items-start">
          {pricingTiers.map((tier, index) => (
            <SectionReveal key={tier.title} delay={index * 0.2}>
              <PricingCard 
                {...tier}
              />
            </SectionReveal>
