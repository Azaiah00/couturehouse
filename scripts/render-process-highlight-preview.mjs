...
const files = [
  "story-process-01-discover.png",
  "story-process-02-position.png",
  "story-process-03-direct.png",
  "story-process-04-build.png",
  "story-process-05-refine.png",
  "story-process-06-launch.png",
];
...
const title = Buffer.from(`<svg width="1020" height="1175" xmlns="http://www.w3.org/2000/svg">
  <text x="55" y="58" fill="#fffaf2" font-family="Arial,Helvetica,sans-serif" font-size="27" font-weight="700" letter-spacing="4">COUTURE HOUSE / PROCESS HIGHLIGHT</text>
...
await sharp({ create: { width: 1020, height: 1175, channels: 4, background: "#080808" } })
  ...
  .toFile(join(root, "marketing/instagram/highlights/process-highlight-preview.png"));
